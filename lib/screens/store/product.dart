      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text(
              'Camiseta do Kit Atlética Biopark 2025!',
              style: TextStyle(color: Colors.white),
            ),
